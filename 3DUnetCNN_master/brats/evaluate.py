...
def main():
    ...
    rows = list()
    subject_ids = list()
    for case_folder in glob.glob("prediction/predictionresults/*"):
    ...
    df.to_csv("./prediction/predictionresults/brats_scores.csv")
    ...
    plt.savefig("./prediction/predictionresults/validation_scores_boxplot.png")
    plt.close()
    ...
    if os.path.exists("./training.log"):
        ...
        plt.savefig('./prediction/predictionresults/loss_graph.png')
